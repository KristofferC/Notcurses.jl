...
function ncchannel_alpha(channel)
    @ccall libnotcurses_ffi.ncchannel_alpha(channel::UInt32)::Cuint
end
...
function ncchannel_set_palindex(channel, idx)
    @ccall libnotcurses_ffi.ncchannel_set_palindex(channel::Ptr{UInt32}, idx::Cint)::Cint
end
...
function ncchannel_rgb8(channel, r, g, b)
    @ccall libnotcurses_ffi.ncchannel_rgb8(channel::UInt32, r::Ptr{Cuint}, g::Ptr{Cuint}, b::Ptr{Cuint})::Cuint
end
...
function ncchannels_set_fg_palindex(channels, idx)
    @ccall libnotcurses_ffi.ncchannels_set_fg_palindex(channels::Ptr{UInt64}, idx::Cint)::Cint
end
...
function ncchannels_set_bg_palindex(channels, idx)
    @ccall libnotcurses_ffi.ncchannels_set_bg_palindex(channels::Ptr{UInt64}, idx::Cint)::Cint
end
...
function nccell_set_fg_alpha(c, alpha)
    @ccall libnotcurses_ffi.nccell_set_fg_alpha(c::Ptr{nccell}, alpha::Cint)::Cint
end
...
function nccell_set_bg_alpha(c, alpha)
    @ccall libnotcurses_ffi.nccell_set_bg_alpha(c::Ptr{nccell}, alpha::Cint)::Cint
end
...
function nccell_set_fg_palindex(cl, idx)
    @ccall libnotcurses_ffi.nccell_set_fg_palindex(cl::Ptr{nccell}, idx::Cint)::Cint
end
...
function nccell_set_bg_palindex(cl, idx)
    @ccall libnotcurses_ffi.nccell_set_bg_palindex(cl::Ptr{nccell}, idx::Cint)::Cint
end
...
function nccells_load_box(n, styles, channels, ul, ur, ll, lr, hl, vl, gclusters)
    @ccall libnotcurses_ffi.nccells_load_box(n::Ptr{ncplane}, styles::UInt32, channels::UInt64, ul::Ptr{nccell}, ur::Ptr{nccell}, ll::Ptr{nccell}, lr::Ptr{nccell}, hl::Ptr{nccell}, vl::Ptr{nccell}, gclusters::Ptr{Cchar})::Cint
end
...
function ncpixel(r, g, b)
    @ccall libnotcurses_ffi.ncpixel(r::Cint, g::Cint, b::Cint)::UInt32
end
...
function ncdirect_light_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
    @ccall libnotcurses_ffi.ncdirect_light_box(n::Ptr{ncdirect}, ul::UInt64, ur::UInt64, ll::UInt64, lr::UInt64, ylen::Cuint, xlen::Cuint, ctlword::Cuint)::Cint
end
...
function ncdirect_heavy_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
    @ccall libnotcurses_ffi.ncdirect_heavy_box(n::Ptr{ncdirect}, ul::UInt64, ur::UInt64, ll::UInt64, lr::UInt64, ylen::Cuint, xlen::Cuint, ctlword::Cuint)::Cint
end
...
function ncdirect_ascii_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
    @ccall libnotcurses_ffi.ncdirect_ascii_box(n::Ptr{ncdirect}, ul::UInt64, ur::UInt64, ll::UInt64, lr::UInt64, ylen::Cuint, xlen::Cuint, ctlword::Cuint)::Cint
end
...
function ncdirect_get_nblock(n, ni)
    @ccall libnotcurses_ffi.ncdirect_get_nblock(n::Ptr{ncdirect}, ni::Ptr{ncinput})::UInt32
end
...
function ncdirect_get_blocking(n, ni)
    @ccall libnotcurses_ffi.ncdirect_get_blocking(n::Ptr{ncdirect}, ni::Ptr{ncinput})::UInt32
end
...
function ncdirect_cantruecolor(n)
    @ccall libnotcurses_ffi.ncdirect_cantruecolor(n::Ptr{ncdirect})::Bool
end
...
function ncdirect_canchangecolor(n)
    @ccall libnotcurses_ffi.ncdirect_canchangecolor(n::Ptr{ncdirect})::Bool
end
...
function ncdirect_canfade(n)
    @ccall libnotcurses_ffi.ncdirect_canfade(n::Ptr{ncdirect})::Bool
end
...
function ncdirect_canopen_images(n)
    @ccall libnotcurses_ffi.ncdirect_canopen_images(n::Ptr{ncdirect})::Bool
end
...
function ncdirect_canopen_videos(n)
    @ccall libnotcurses_ffi.ncdirect_canopen_videos(n::Ptr{ncdirect})::Bool
end
...
function ncdirect_canhalfblock(nc)
    @ccall libnotcurses_ffi.ncdirect_canhalfblock(nc::Ptr{ncdirect})::Bool
end
...
function ncdirect_canquadrant(nc)
    @ccall libnotcurses_ffi.ncdirect_canquadrant(nc::Ptr{ncdirect})::Bool
end
...
function ncdirect_cansextant(nc)
    @ccall libnotcurses_ffi.ncdirect_cansextant(nc::Ptr{ncdirect})::Bool
end
...
function ncdirect_canbraille(nc)
    @ccall libnotcurses_ffi.ncdirect_canbraille(nc::Ptr{ncdirect})::Bool
end
